            ...
            <div class="col-lg-4">
                <div class="footer-about text-center">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="m-0 text-white"><i class="fa fa-user-tie me-2"></i>Internify</h1>
                    </a>
                    <p class="mt-3">To streamline and enhance the internship process for both students and organizations, Internify comes into play.</p>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-md-6">
                        <div class="footer-contact">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">internify@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
